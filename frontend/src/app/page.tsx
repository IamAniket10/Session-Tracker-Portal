        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <Link href="#features" className="text-gray-900 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-500 transition-colors">Features</Link>
              <Link href="#testimonials" className="text-gray-900 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-500 transition-colors">Testimonials</Link>
              <Link href="#about" className="text-gray-900 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-500 transition-colors">About Us</Link>
              <ThemeToggle />
              <Link href="/login">
          ...
          {isOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                <Link href="#features" className="px-2 py-1 text-gray-900 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-500 transition-colors">Features</Link>
                <Link href="#testimonials" className="px-2 py-1 text-gray-900 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-500 transition-colors">Testimonials</Link>
                <Link href="#about" className="px-2 py-1 text-gray-900 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-500 transition-colors">About Us</Link>
                <Link href="/login">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="#about" className="text-gray-400 hover:text-brand-500 transition-colors">About Us</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Careers</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Blog</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Press</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Contact</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Privacy Policy</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Terms of Service</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Cookie Policy</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">HIPAA Compliance</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-brand-500 transition-colors">Data Processing</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                <Link href="#" className="text-gray-400 hover:text-brand-500 text-sm transition-colors">Privacy</Link>
                <Link href="#" className="text-gray-400 hover:text-brand-500 text-sm transition-colors">Terms</Link>
                <Link href="#" className="text-gray-400 hover:text-brand-500 text-sm transition-colors">Cookies</Link>
              </div>
            </div>
          </div>
        </div>
